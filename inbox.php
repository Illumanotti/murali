      ...
      <div class="demo-headline">
		...
		<div class="row">
			<div class="col-lg-12 align-center lato-font">
				<p class="home-title inbox-title">Your inbox</p>
		  </div>
       </div>
	   <div class="row">
			...
			<div class="col-lg-4 align-center lato-font">
				<p class="inbox-title">You have 1 unread message</p><br/>
				<div class="row">
				<div class="col-sm-12 inbox-box">
				<div class="row">
				<div class="col-md-1"><br/><p class="home-title glyphicon glyphicon-envelope"></p></div>
				<div class="col-md-7 inbox-msgBox"><div class="row">Hello</div><div class="row">from the team</div></div>
				<div class="col-md-4">
				<div class="row"><div class="col-sm-12"><a class="btn btn-sm btn-success" href="#">Reply</a>
				<a class="btn btn-sm btn-danger" href="#">Delete</a></div></div>
				</div>
				</div>
				</div>
				</div>
